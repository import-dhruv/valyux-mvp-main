  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <h2 className="text-xl lg:text-2xl font-bold text-foreground">Comparing {selectedProducts.length} Products</h2>
        <div className="flex gap-2 lg:gap-3">
          <Button variant="outline" size="sm" className="flex items-center gap-2 bg-transparent text-xs lg:text-sm">
            <Download className="w-3 h-3 lg:w-4 lg:h-4" />
            <span className="hidden sm:inline">Export</span>
          </Button>
          <Button variant="outline" size="sm" onClick={clearComparison} className="text-xs lg:text-sm">
            Clear All
          </Button>
        </div>
      </div>
      ...
      <div className="overflow-x-auto bg-card rounded-lg border border-border -mx-4 sm:mx-0">
      ...
      <div className="bg-card rounded-lg p-4 border border-border">
        ...
        <ul className="text-xs lg:text-sm text-muted-foreground space-y-2">
          ...
          <li className="text-primary">• Scroll horizontally on mobile to see all products</li>
        </ul>
      </div>
    </div>
  )
